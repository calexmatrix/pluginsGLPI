...
class FileField extends PluginFormcreatorAbstractField
{
   ...
   public function isValid(): bool {
      ...
      //if (($this->isRequired() && count($this->uploads[$key]) < 1)) { bug na hora de anexar arquivo
	  if (($this->isRequired() &&($this->uploads[$key]) < 1)) {
         Session::addMessageAfterRedirect(
            sprintf(__('ARQUIVO REQUERIDO AUSENTE: %s', 'formcreator'), $this->getLabel()),
